...
TRACK__BORDER = scale_image(pygame.image.load("imgs/track-border.png"), 0.9)
TRACK__BORDER_MASK = pygame.mask.from_surface(TRACK__BORDER)
...
def handle_collision(player_car, computer_car, game_info):
	if player_car.collide(TRACK__BORDER_MASK) != None:
		print("collide")
		player_car.bounce()
	
	computer_finish_poi_collide = computer_car.collide(FINISH_MASK, *FINISH_POSITION)
	if computer_finish_poi_collide != None:
		blit_text_center(WIN, MAIN_FONT, "U LOST")
		pygame.display.update()
...
images = [(GRASS, (0, 0)), (TRACK, (0, 0)), (FINISH, FINISH_POSITION), (TRACK__BORDER, (0, 0))]
